...
<?php if (!empty(get_field("balcony_space")) || !empty(get_field("floor_space")) || !empty(get_field("pets_allowed"))) { ?>
            <div class="col-xs-12 apartment-attributes">
                <ul>
                    <?php if (!empty(get_field("balcony_space"))): ?>
                    <li>Balcony space: <span><?php the_field("balcony_space") ?>m<sup>2</sup></span></li>
                    <?php endif; ?>

                    <?php if (!empty(get_field("floor_space"))): ?>
                    <li>Floor space: <span><?php the_field("floor_space") ?>m<sup>2</sup></span></li>
                    <?php endif; ?>

                    <?php if (!empty(get_field("pets_allowed"))): ?>
